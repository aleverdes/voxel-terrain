...
//         private Dictionary<VoxelTerrainEditorTool, Button> _toolbarButton = new();
//         
...
//
//         private VoxelTerrainEditorTool Tool
//         {
//             get => Target.LastVoxelTerrainEditorTool;
//             set => Target.LastVoxelTerrainEditorTool = value;
//         }
//
...
//                 SetTool(VoxelTerrainEditorTool.Selection);
//
//             if (GUILayout.Button("P")) 
//                 SetTool(VoxelTerrainEditorTool.Painting);
//
//             if (GUILayout.Button("H")) 
//                 SetTool(VoxelTerrainEditorTool.Height);
//
//             if (GUILayout.Button("x")) 
//                 SetTool(VoxelTerrainEditorTool.CellDeleting);
//
//             if (GUILayout.Button("+")) 
//                 SetTool(VoxelTerrainEditorTool.CellRestoring);
//
...
//             
//             if (Tool != VoxelTerrainEditorTool.None && Tool != VoxelTerrainEditorTool.Height && Tool != VoxelTerrainEditorTool.Painting)
//             {
//                 ProcessSelectionTool();
//             }
//             else if (Tool == VoxelTerrainEditorTool.Painting)
//             {
//                 ProcessPaintingTool();
//             }
//             else if (Tool == VoxelTerrainEditorTool.Height)
//             {
//                 ProcessHeightTool();
//             }
//             
...
//                     else
//                     {
//                         if (Tool == VoxelTerrainEditorTool.Selection)
//                         {
//                             if (modeShiftKey)
//                             {
...
//             {
//                 if (Tool == VoxelTerrainEditorTool.Height)
//                 {
